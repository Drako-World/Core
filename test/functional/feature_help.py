...
"""Verify that starting drakocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start drakocoin with -h for help text")
        ...
        self.log.info("Start drakocoin with -version for version information")
        ...
        self.log.info("Start drakocoind with -fakearg to make sure it does not start")
