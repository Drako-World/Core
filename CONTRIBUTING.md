Contributing to DrakoCoin Core
============================

The DrakoCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the DrakoCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/drakocoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to drakocoin-qt
...
The following applies to code changes to the DrakoCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall DrakoCoin
Network Protocol consensus changes.

Whether a pull request is merged into DrakoCoin Core rests with the project merge
...
Patches that change DrakoCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the DrakoCoin consensus, it must have been
...
The project leader is the release manager for each DrakoCoin Core release.
