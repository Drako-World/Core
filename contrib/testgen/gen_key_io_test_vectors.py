...
bech32_templates = [
  ...
  ('drkc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('drkc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('drkc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('drkc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tdrkc',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tdrkc',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tdrkc',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tdrkc',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tdrkc',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tdrkc',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tdrkc',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tdrkc',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rdrkc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rdrkc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rdrkc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rdrkc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tdrkc',   17, 32, Encoding.BECH32M, False, False, False),
  ('rdrkc',  3,  1, Encoding.BECH32M, False, False, False),
  ('drkc',   15, 41, Encoding.BECH32M, False, False, False),
  ('tdrkc',    0, 16, Encoding.BECH32,  False, False, False),
  ('rdrkc',  0, 32, Encoding.BECH32,  True,  False, False),
  ('drkc',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tdrkc',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rdrkc',  0, 20, Encoding.BECH32,  False, False, True),
  ('drkc',    0, 20, Encoding.BECH32M, False, False, False),
  ('tdrkc',    0, 32, Encoding.BECH32M, False, False, False),
  ('rdrkc',  0, 20, Encoding.BECH32M, False, False, False),
  ('drkc',    1, 32, Encoding.BECH32,  False, False, False),
  ('tdrkc',    2, 16, Encoding.BECH32,  False, False, False),
  ('rdrkc', 16, 20, Encoding.BECH32,  False, False, False),
]
