...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " drakocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  drakocoin-tx [options] <hex-tx> [commands]  Update hex-encoded drakocoin transaction\n" +
            "or:     drakocoin-tx [options] -create [commands]   Create hex-encoded drakocoin transaction\n" +
            "\n";
