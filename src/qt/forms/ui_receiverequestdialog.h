...
public:
    ...
    void setupUi(QDialog *ReceiveRequestDialog)
    {
        ...
        uri_content->setText(QStringLiteral("drakocoin:DRKC1..."));
        ...
        amount_content->setText(QStringLiteral("0.00000000 BTC"));
    ...
    {
        ReceiveRequestDialog->setWindowTitle(QApplication::translate("ReceiveRequestDialog", "Request payment to ...", Q_NULLPTR));
        payment_header->setText(QApplication::translate("ReceiveRequestDialog", "Payment information", Q_NULLPTR));
        address_tag->setText(QApplication::translate("ReceiveRequestDialog", "Address:", Q_NULLPTR));
        amount_tag->setText(QApplication::translate("ReceiveRequestDialog", "Amount:", Q_NULLPTR));
        label_tag->setText(QApplication::translate("ReceiveRequestDialog", "Label:", Q_NULLPTR));
        message_tag->setText(QApplication::translate("ReceiveRequestDialog", "Message:", Q_NULLPTR));
        wallet_tag->setText(QApplication::translate("ReceiveRequestDialog", "Wallet:", Q_NULLPTR));
