...
public:
    ...
    void setupUi(QDialog *ReceiveCoinsDialog)
    {
        ...
        useMWEB = new QCheckBox(frame2);
        useMWEB->setObjectName(QStringLiteral("useMWEB"));

        horizontalLayout_6->addWidget(useMWEB);
    ...
    void retranslateUi(QDialog *ReceiveCoinsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the DrakoCoin network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        useMWEB->setText(QApplication::translate("ReceiveCoinsDialog", "Generate MWEB address", Q_NULLPTR));
