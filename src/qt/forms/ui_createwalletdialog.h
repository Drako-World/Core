...
public:
    ...
    void retranslateUi(QDialog *CreateWalletDialog)
    {
        ...
        wallet_name_label->setText(QApplication::translate("CreateWalletDialog", "Wallet Name", Q_NULLPTR));
        wallet_name_line_edit->setPlaceholderText(QApplication::translate("CreateWalletDialog", "Wallet", Q_NULLPTR));
        ...
        groupBox->setTitle(QApplication::translate("CreateWalletDialog", "Advanced Options", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        descriptor_checkbox->setToolTip(QApplication::translate("CreateWalletDialog", "Use descriptors for scriptPubKey management", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        descriptor_checkbox->setText(QApplication::translate("CreateWalletDialog", "Descriptor Wallet", Q_NULLPTR));
    } // retranslateUi
