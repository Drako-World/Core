...
public:
    ...
    QFrame *frameMWEBFeatures;
    QVBoxLayout *verticalLayoutMWEBFeatures2;
    QVBoxLayout *verticalLayoutMWEBFeatures;
    QHBoxLayout *horizontalLayoutMWEBFeatures1;
    QLabel *labelMWEBFeatures;
    QHBoxLayout *horizontalLayoutMWEBFeatures2;
    QPushButton *pushButtonMWEBPegIn;
    QPushButton *pushButtonMWEBPegOut;
    QSpacerItem *horizontalSpacerMWEBFeatures;
    QSpacerItem *verticalSpacerMWEBFeatures;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        SendCoinsDialog->resize(850, 593);
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DRKC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DRKC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DRKC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DRKC"));
        ...
        frameMWEBFeatures = new QFrame(SendCoinsDialog);
        frameMWEBFeatures->setObjectName(QStringLiteral("frameMWEBFeatures"));
        sizePolicy.setHeightForWidth(frameMWEBFeatures->sizePolicy().hasHeightForWidth());
        frameMWEBFeatures->setSizePolicy(sizePolicy);
        frameMWEBFeatures->setMaximumSize(QSize(16777215, 16777215));
        frameMWEBFeatures->setFrameShape(QFrame::StyledPanel);
        frameMWEBFeatures->setFrameShadow(QFrame::Sunken);
        verticalLayoutMWEBFeatures2 = new QVBoxLayout(frameMWEBFeatures);
        verticalLayoutMWEBFeatures2->setSpacing(0);
        verticalLayoutMWEBFeatures2->setObjectName(QStringLiteral("verticalLayoutMWEBFeatures2"));
        verticalLayoutMWEBFeatures2->setContentsMargins(0, 0, 0, 6);
        verticalLayoutMWEBFeatures = new QVBoxLayout();
        verticalLayoutMWEBFeatures->setSpacing(0);
        verticalLayoutMWEBFeatures->setObjectName(QStringLiteral("verticalLayoutMWEBFeatures"));
        verticalLayoutMWEBFeatures->setContentsMargins(10, 10, -1, -1);
        horizontalLayoutMWEBFeatures1 = new QHBoxLayout();
        horizontalLayoutMWEBFeatures1->setObjectName(QStringLiteral("horizontalLayoutMWEBFeatures1"));
        horizontalLayoutMWEBFeatures1->setContentsMargins(-1, -1, -1, 15);
        labelMWEBFeatures = new QLabel(frameMWEBFeatures);
        labelMWEBFeatures->setObjectName(QStringLiteral("labelMWEBFeatures"));
        sizePolicy1.setHeightForWidth(labelMWEBFeatures->sizePolicy().hasHeightForWidth());
        labelMWEBFeatures->setSizePolicy(sizePolicy1);
        labelMWEBFeatures->setFont(font);
        labelMWEBFeatures->setStyleSheet(QStringLiteral("font-weight:bold;"));

        horizontalLayoutMWEBFeatures1->addWidget(labelMWEBFeatures);


        verticalLayoutMWEBFeatures->addLayout(horizontalLayoutMWEBFeatures1);

        horizontalLayoutMWEBFeatures2 = new QHBoxLayout();
        horizontalLayoutMWEBFeatures2->setSpacing(8);
        horizontalLayoutMWEBFeatures2->setObjectName(QStringLiteral("horizontalLayoutMWEBFeatures2"));
        horizontalLayoutMWEBFeatures2->setContentsMargins(-1, -1, -1, 10);
        pushButtonMWEBPegIn = new QPushButton(frameMWEBFeatures);
        pushButtonMWEBPegIn->setObjectName(QStringLiteral("pushButtonMWEBPegIn"));
        pushButtonMWEBPegIn->setStyleSheet(QStringLiteral(""));
        pushButtonMWEBPegIn->setCheckable(true);
        pushButtonMWEBPegIn->setAutoDefault(false);

        horizontalLayoutMWEBFeatures2->addWidget(pushButtonMWEBPegIn);

        pushButtonMWEBPegOut = new QPushButton(frameMWEBFeatures);
        pushButtonMWEBPegOut->setObjectName(QStringLiteral("pushButtonMWEBPegOut"));
        pushButtonMWEBPegOut->setStyleSheet(QStringLiteral(""));
        pushButtonMWEBPegOut->setCheckable(true);
        pushButtonMWEBPegOut->setAutoDefault(false);

        horizontalLayoutMWEBFeatures2->addWidget(pushButtonMWEBPegOut);

        horizontalSpacerMWEBFeatures = new QSpacerItem(40, 1, QSizePolicy::Expanding, QSizePolicy::Minimum);

        horizontalLayoutMWEBFeatures2->addItem(horizontalSpacerMWEBFeatures);


        verticalLayoutMWEBFeatures->addLayout(horizontalLayoutMWEBFeatures2);

        verticalSpacerMWEBFeatures = new QSpacerItem(800, 1, QSizePolicy::Minimum, QSizePolicy::Expanding);

        verticalLayoutMWEBFeatures->addItem(verticalSpacerMWEBFeatures);

        verticalLayoutMWEBFeatures->setStretch(2, 1);

        verticalLayoutMWEBFeatures2->addLayout(verticalLayoutMWEBFeatures);


        verticalLayout->addWidget(frameMWEBFeatures);
        ...
        labelBalance->setText(QStringLiteral("123.456 DRKC"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelMWEBFeatures->setText(QApplication::translate("SendCoinsDialog", "Advanced MWEB Features", Q_NULLPTR));
        pushButtonMWEBPegIn->setText(QApplication::translate("SendCoinsDialog", "Peg-In DRKC", Q_NULLPTR));
        pushButtonMWEBPegOut->setText(QApplication::translate("SendCoinsDialog", "Peg-Out DRKC", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        labelCustomFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for drakocoin transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
