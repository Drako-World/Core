...
public:
    ...
    {
        PSBTOperationsDialog->setWindowTitle(QApplication::translate("PSBTOperationsDialog", "Dialog", Q_NULLPTR));
        statusBar->setText(QString());
        signTransactionButton->setText(QApplication::translate("PSBTOperationsDialog", "Sign Tx", Q_NULLPTR));
        broadcastTransactionButton->setText(QApplication::translate("PSBTOperationsDialog", "Broadcast Tx", Q_NULLPTR));
        copyToClipboardButton->setText(QApplication::translate("PSBTOperationsDialog", "Copy to Clipboard", Q_NULLPTR));
        saveButton->setText(QApplication::translate("PSBTOperationsDialog", "Save...", Q_NULLPTR));
        closeButton->setText(QApplication::translate("PSBTOperationsDialog", "Close", Q_NULLPTR));
    } // retranslateUi
