...
public:
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The DrakoCoin address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less drakocoins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the drakocoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the DrakoCoin network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
