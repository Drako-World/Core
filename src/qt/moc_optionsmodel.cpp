...
QT_MOC_LITERAL(5, 65, 19), // "mwebFeaturesChanged"
QT_MOC_LITERAL(6, 85, 19) // "hideTrayIconChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "coinControlFeaturesChanged\0"
    "mwebFeaturesChanged\0hideTrayIconChanged"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->mwebFeaturesChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::mwebFeaturesChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void OptionsModel::mwebFeaturesChanged(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
