# Support for Output Descriptors in DrakoCoin Core

Since DrakoCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `drkc1...` for mainnet or `tdrkc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing DrakoCoin Core wallets, a convenience function `combo` is
